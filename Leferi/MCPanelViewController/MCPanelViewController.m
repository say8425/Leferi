...
- (void)refreshBackgroundAnimated:(BOOL)animated {
    ...
    switch (self.backgroundStyle) {
        ...
        case MCPanelBackgroundStyleCustomLight:
            image = [image applyCustomLight];
            break;

        case MCPanelBackgroundStyleCustomTint:
            image = [image applyCustomLightWithColor:self.tintColor];
